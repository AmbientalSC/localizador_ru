/* pytesNET/tail.DateTime v.0.4.14 | Full Version | @author SamBrishes, pytesNET <sam@pytes.net> | @license MIT */ ! function (t, e) {
    "function" == typeof define && define.amd ? define(function () {
        return e(t, t.document)
    }) : "object" == typeof module && module.exports ? module.exports = e(t, t.document) : (void 0 === t.tail && (t.tail = {}), t.tail.DateTime = t.tail.datetime = e(t, t.document), "undefined" != typeof jQuery && (jQuery.fn.DateTime = jQuery.fn.datetime = function (t) {
        var e, i = [];
    ...
    function s(t, e, i) {
        ...
        else(a = h.createEvent("CustomEvent")).initCustomEvent(e, !!i.bubbles, !!i.cancelable, i.detail);
    ...
    return c.version = "0.4.14", c.status = "beta", c.count = 0, c.inst = {}, c.defaults = {
        ...
        modify: function (t, e, i) {
            ...
            if (e instanceof Object)
                for (var a in e) this.modify(t, a, e[a]);
        ...
        init: function () {
            ...
            this.weekdays = "<thead>\n<tr>\n";
            for (var e = 0; e < 7; e++) this.weekdays += '<th class="calendar-week">' + t[e] + "</th>";
            ...
            for (e = 0; e < 3; e++)
                if ("number" == typeof this.con["time" + i[e]]) this.view.date["set" + i[e]](this.con["time" + i[e]]);
                else
                    for (; this.view.date["get" + i[e]]() % this.con["timeStep" + i[e]] != 0;) this.view.date["set" + i[e]](this.view.date["get" + i[e]]() + 1);
        ...
        prepare: function () {
            if (this.__ = o(c.strings.en, c.strings[this.con.locale] || {}), this.con.dateStart = l(this.con.dateStart, !0, !0) || -9999999999999, this.con.dateEnd = l(this.con.dateEnd, !0, !0) || 9999999999999, this.con.viewDefault = this.con.dateFormat ? this.con.viewDefault : "time", "string" == typeof this.con.weekStart && (this.con.weekStart = c.strings.en.shorts.indexOf(this.con.weekStart)), this.con.weekStart < 0 && 6 < this.con.weekStart && (this.con.weekStart = 0), 0 < this.con.dateRanges.length) {
                for (var t = [], e = (n = this.con.dateRanges).length, i = 0; i < e; i++) n[i] instanceof Object && (n[i].start || n[i].days) && (!1 === (n[i].start = l(n[i].start || !1, !0, !0)) ? n[i].start = n[i].end = 1 / 0 : (!1 === (n[i].end = l(n[i].end || !1, !0, !0)) && (n[i].end = n[i].start), n[i].start = n[i].start > n[i].end ? [n[i].end, n[i].end = n[i].start][0] : n[i].start), n[i].days = !("days" in n[i]) || n[i].days, n[i].days = "boolean" != typeof n[i].days ? function (t) {
                    for (var e = [], i = t.length, a = 0; a < i; a++) "string" == typeof t[a] && (t[a] = c.strings.en.shorts.indexOf(t[a])), 0 <= t[a] && t[a] <= 6 && e.push(t[a]);
                    return e
            ...
            if (0 < this.con.tooltips.length) {
                t = [];
                var a, n, s = this.con.tooltips;
                for (e = s.length, i = 0; i < e; i++) s[i] instanceof Object && s[i].date && (s[i].date instanceof Array ? (a = l(s[i].date[0] || !1, !0, !0), n = l(s[i].date[1] || !1, !0, !0) || a) : a = n = l(s[i].date || !1, !0, !0), a && t.push({
                    date: a !== n ? [a, n] : a,
        ...
        trigger: function (t) {
            ...
            for (var i = (this.events[t] || []).length, a = 0; a < i; a++) this.events[t][a].cb.apply(this, function (t, e, i) {
        ...
        renderTimePicker: function (t) {
            ...
            for (n = 0; n < c.length; n++) "checkbox" !== c[n].type ? (c[n].addEventListener("input", function (t) {
            ...
            for (c = o.querySelectorAll("button"), n = 0; n < c.length; n++) c[n].addEventListener("mousedown", function (t) {
                t.preventDefault();
        ...
        handleLabel: function (t) {
            var e, i, a = t.querySelector(".label");
        ...
        viewDecades: function () {
            ...
            for (var a, n, s = [], r = [], o = 1; o <= 16; o++) a = "calendar-decade" + (i >= e.getYear() && i <= e.getYear() + 10 ? " date-today" : ""), n = 'data-action="view" data-view="down" data-year="' + e.getFullYear() + '"', s.push('<td class="' + a + '" ' + n + '><span class="inner">' + e.getFullYear() + " - " + (e.getFullYear() + 10) + "</span></td>"), 4 <= o && o % 4 == 0 && (r.push("<tr>\n" + s.join("\n") + "\n</tr>"), s = []), e.setFullYear(e.getFullYear() + 10);
        ...
        viewYears: function () {
            ...
            for (var a, n, s = [], r = [], o = 1; o <= 16; o++) a = "calendar-year" + (e.getYear() == i ? " date-today" : ""), n = 'data-action="view" data-view="down" data-year="' + e.getFullYear() + '"', s.push('<td class="' + a + '" ' + n + '><span class="inner">' + e.getFullYear() + "</span></td>"), 4 <= o && o % 4 == 0 && (r.push("<tr>\n" + s.join("\n") + "\n</tr>"), s = []), e.setFullYear(e.getFullYear() + 1);
        ...
        viewMonths: function () {
            ...
            for (var i, a, n = [], s = [], r = 0; r < 12; r++) i = "calendar-month" + (e == r ? " date-today" : ""), a = 'data-action="view" data-view="down" data-month="' + r + '"', n.push('<td class="' + i + '" ' + a + '><span class="inner">' + t[r] + "</span></td>"), 3 == n.length && (s.push("<tr>\n" + n.join("\n") + "\n</tr>"), n = []);
            return '<table class="calendar-months"><thead><tr><th colspan="3">' + this.__.header[0] + "</th></tr></thead><tbody>" + s.join("\n") + "</tbody></table>"
        },
        viewDays: function () {
            var i, t, e, a, n, s = new Date(this.view.date.getTime()),
            ...
            for (s.setHours(0, 0, 0, 0), s.setDate(1), s.setDate(1 - (s.getDay() - this.con.weekStart)); c.length < 6;) i = s.getTime(), e = 'data-action="submit" data-date="' + s.getTime() + '"', t = "calendar-day date-" + (s.getMonth() > o ? "next" : s.getMonth() < o ? "previous" : "current"), this.con.today && r == s.toDateString() && (t += " date-today"), this.con.dateBlacklist && (i < this.con.dateStart || i > this.con.dateEnd) ? d = [i < this.con.dateStart ? this.con.dateStart : 1 / 0, [0, 1, 2, 3, 4, 5, 6], !0] : 0 == d[0] ? h = h.filter(function (t) {
                return t.start == 1 / 0 || i >= t.start && i <= t.end ? !(d = [t.end, t.days]) : t.start > i
            }, this) : 3 == d.length && (d = [0, [0, 1, 2, 3, 4, 5, 6]]), 0 < this.con.tooltips.length && this.con.tooltips.filter(function (t, e) {
                t.date instanceof Array ? t.date[0] <= i && t.date[1] >= i && (u = [t.date[1], e, t.color]) : t.date == i && (u = [t.date, e, t.color])
            }, this), u[0] < i && (u = [0, 0]), (n = d[0] >= i && 0 <= d[1].indexOf(s.getDay())) && this.con.dateBlacklist || !n && !this.con.dateBlacklist ? (t += " date-disabled", e += ' data-disabled="true"') : 0 !== d[0] && d[0] <= i && (d = [0, []]), this.select && this.select.toDateString() == s.toDateString() && (t += " date-select"), a = '<span class="inner">' + s.getDate() + "</span>", 0 < u[0] && (t += " date-tooltip", e += ' data-tooltip="' + u[1] + '" data-tooltip-time="' + i + '"', "inherit" !== u[2] ? a += '<span class="tooltip-tick" style="background:' + u[2] + ';"></span>' : a += '<span class="tooltip-tick"></span>'), l.push('<td class="' + t + '" ' + e + ">" + a + "</td>"), 7 == l.length && (c.push("<tr>\n" + l.join("\n") + "\n</tr>"), l = []), s.setDate(s.getDate() + 1);
            return c = "<tbody>" + c.join("\n") + "</tbody>", '<table class="calendar-days">' + this.weekdays + c + "</table>"
        },
        showTooltip: function (t, e, i) {
            var a, n = this.con.tooltips[t].element,
                s = n.style,
        ...
        switchDate: function (t, e, i, a) {
            if (this.view.date.setFullYear(null == t ? this.view.date.getFullYear() : t), this.view.date.setMonth(null == e ? this.view.date.getMonth() : e), "auto" == i) {
                var n = this.view.date,
                    s = new Date;
                i = n.getMonth() == s.getMonth() && n.getYear() == s.getYear() ? s.getDate() : 1
            }
            return this.view.date.setDate(i || this.view.date.getDate()), !0 === a || this.switchView(this.view.type)
        },
        ...
        open: function () {
            ...
            var e = this,
                i = this.dt.style;
            return i.display = "block", i.opacity = this.con.animate ? 0 : 1, n(this.dt, "calendar-close"), a(this.dt, "calendar-idle"), u(this.dt, "calendar-static") || e.calcPosition(),
                function t() {
        ...
        close: function () {
            ...
            var e = this,
                i = this.dt.style;
            return i.display = "block", i.opacity = this.con.animate ? 1 : 0, n(this.dt, "calendar-open"), a(this.dt, "calendar-idle"),
                function t() {
